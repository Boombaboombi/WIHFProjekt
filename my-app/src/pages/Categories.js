...
function CategoryList() {
  ...
  const filteredCategories = categories.filter(category => 
    category.CategoryName && category.CategoryName.toLowerCase().includes(filterCategoryName.toLowerCase())
);
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <table className="min-w-full bg-white border">
        <thead>
          <tr>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('CategoryName')}>
              Category Name {sortConfig.key === 'CategoryName' ? (sortConfig.direction === 'asc' ? '↑' : '↓') : ''}
            </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('Description')}>
              Description {sortConfig.key === 'Description' ? (sortConfig.direction === 'asc' ? '↑' : '↓') : ''}
              </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left">Actions</th>
          </tr>
        </thead>
        <tbody>
