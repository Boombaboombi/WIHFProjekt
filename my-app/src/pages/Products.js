...
function ProductList() {
  ...
  // Function to export products as a CSV file
  const exportToCSV = () => {
    // Define CSV headers and rows
    const headers = ["Product Name", "Price", "Unit", "Supplier", "Category"];
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="mb-4">
        <input
          className="border p-2 mb-2 w-full shadow-md border-gray-300 rounded"
          type="text"
      ...
      <table className="min-w-full bg-white border">
        <thead>
          <tr>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('ProductName')}>
              Product Name {sortConfig.key === 'ProductName' ? (sortConfig.direction === 'asc' ? '↑' : '↓') : ''}
            </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('Price')}>
              Price {sortConfig.key === 'Price' ? (sortConfig.direction === 'asc' ? '↑' : '↓') : ''}
            </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('Unit')}>
              Unit {sortConfig.key === 'Unit' ? (sortConfig.direction === 'asc' ? '↑' : '↓') : ''}
            </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('SupplierID')}>
              Supplier {sortConfig.key === 'SupplierID' ? (sortConfig.direction === 'asc' ? '↑' : '↓') : ''}
            </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('CategoryID')}>
