      ...
      <table className="min-w-full bg-white border">
        <thead>
          <tr>
            ...
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('ContactName')}>
              Contact Name {sortField === 'ContactName' && (sortOrder === 'asc' ? '↑' : '↓')}
            </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('Address')}>
              Address {sortField === 'Address' && (sortOrder === 'asc' ? '↑' : '↓')}
            </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('City')}>
              City {sortField === 'City' && (sortOrder === 'asc' ? '↑' : '↓')}
            </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('PostalCode')}>
              Postal Code {sortField === 'PostalCode' && (sortOrder === 'asc' ? '↑' : '↓')}
            </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('Country')}>
              Country {sortField === 'Country' && (sortOrder === 'asc' ? '↑' : '↓')}
            </th>
            <th className="py-2 px-4 border-b cursor-pointer text-left" onClick={() => handleSort('Phone')}>
